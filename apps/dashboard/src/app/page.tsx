      ...
      <div className="mx-auto flex w-full max-w-7xl gap-6 px-5 py-6">
        <aside className="hidden w-64 shrink-0 rounded-lg border border-white/10 bg-black/35 p-4 backdrop-blur-xl lg:block">
          <div className="mb-8 flex items-center gap-3">
            <span className="grid h-10 w-10 place-items-center rounded-md bg-brand-primary text-black">
              <Bot size={22} />
            </span>
            <div>
              <strong className="block">2mg Suite</strong>
          ...
          {["Overview", "Tickets", "Embeds", "Permissoes", "Blacklist", "Auditoria", "Configuracoes"].map((item) => (
            <a key={item} className="mb-1 block rounded-md px-3 py-2 text-sm text-zinc-300 transition hover:bg-brand-primary/10 hover:text-white">
              {item}
            </a>
          ))}
        </aside>
        ...
        <section className="flex-1">
          <header className="mb-6 flex flex-col justify-between gap-4 rounded-lg border border-white/10 bg-white/[0.04] p-5 backdrop-blur-xl md:flex-row md:items-center">
            <div>
              <p className="text-sm uppercase tracking-[0.22em] text-brand-primary">Painel administrativo</p>
            ...
            <div className="flex gap-3">
              ...
              <Button className="bg-brand-primary text-black hover:bg-brand-primary/90">Publicar painel</Button>
            </div>
          </header>
          ...
          <div className="mt-6 grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
            <Card className="p-5">
              <div className="mb-5 flex items-center justify-between">
                ...
                <span className="rounded-md border border-brand-success/30 px-2 py-1 text-xs text-brand-success">live-ready</span>
              </div>
              <div className="space-y-3">
                {[
                  ...
                  <div key={title} className="rounded-md border border-white/10 bg-black/25 p-4 transition hover:border-brand-primary/40">
            ...
            <Card className="p-5">
              ...
              <p className="mt-2 text-sm text-zinc-400">Embeds com tema preto e azul profissional, componentes editaveis e consistencia visual.</p>
              <div className="mt-5 rounded-lg border border-brand-primary/30 bg-[#0d0710] p-4">
                <p className="text-xs uppercase tracking-[0.2em] text-brand-primary">preview</p>
